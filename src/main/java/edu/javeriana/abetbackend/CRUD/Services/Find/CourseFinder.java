...
public class CourseFinder {
    ...
    public  Course findCourseById(Long courseId){
        ...
        if(optionalCourse.isEmpty())
            throw new CourseNotFoundById("The course with the id " + courseId + " was not found");
    ...
    public Course findCourseByNumber(Integer courseId){
        ...
        if(optionalCourse.isEmpty())
            throw new CourseNotFoundById("The course with the number " + courseId + " was not found");
        return optionalCourse.get();
    }
    ...
    public Course findCourseByName(String courseName){
        ...
        if(optionalCourse.isEmpty())
            throw new CourseNotFoundByName("The course with the name " + courseName + " was not found");
        return optionalCourse.get();
    }
