...
public class CourseReportController {
    ...
    public ResponseEntity<CourseReportDTO> getCourseReport(@PathVariable Integer courseNumber, @PathVariable Integer semester){
        CourseReportDTO report = reportService.getCourseReportByIdAndSemester(courseNumber, semester);
